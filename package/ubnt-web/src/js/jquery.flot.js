    ...
    function Plot(target_, data_, options_) {
        ...
        function insertLegend() {
            ...
            for (i = 0; i < series.length; ++i) {
                ...
                fragments.push(
                    '<td class="legendColorBox"><div style="border:1px solid ' + options.legend.labelBoxBorderColor + ';padding:1px"><div style="width:12px;height:10px;border:1px;background-color: ' + s.color + ';overflow:hidden"></div></div></td>' +

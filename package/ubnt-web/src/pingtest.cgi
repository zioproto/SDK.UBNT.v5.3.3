...
<body class="popup" onLoad="init();">
	<form name="pingtest" target="ping_results" enctype="multipart/form-data" action="pingtest_action.cgi" method="POST" onSubmit="_runPing(this);return false;">
		...
		<div id="pt_content">
		  ...
		  <td><select class="std_width" id="dst_addr_select" name="dst_addr_select"><option value="0"><? echo dict_translate("or specify manually"); ></option></select><img id="ip_refresh" src="FULL_VERSION_LINK/images/refresh.png " width="16" height="16"></td>

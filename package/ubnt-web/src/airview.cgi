...
<tr><th><? echo dict_translate("AirView"); > <? echo dict_translate("Spectral Analysis"); ></th></tr>
<tr><td>&nbsp;</td></tr>
<tr class="initial_hide stage0"><td align="center">
<? echo dict_translate("msg_airview_warning|WARNING: Launching AirView Spectral Analysis <br/> <span style=\"color: red\">WILL TERMINATE</span> <br/> all wireless connections on the device!"); >
<br /><br />

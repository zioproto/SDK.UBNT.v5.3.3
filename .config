...
CONFIG_DEFAULT_kmod-ag7240=y
CONFIG_DEFAULT_kmod-ag7240-s26phy=y
CONFIG_DEFAULT_kmod-ar7240-gpio=y
CONFIG_DEFAULT_kmod-ath-11n=y
CONFIG_DEFAULT_kmod-ebtables=y
CONFIG_DEFAULT_kmod-ipt-conntrack=y
CONFIG_DEFAULT_kmod-ipt-conntrack-extra=y
CONFIG_DEFAULT_kmod-ipt-nat=y
CONFIG_DEFAULT_kmod-ipt-nathelper=y
CONFIG_DEFAULT_kmod-madwifi=y
CONFIG_DEFAULT_kmod-mppe=y
CONFIG_DEFAULT_kmod-ppp=y
CONFIG_DEFAULT_kmod-pppoe=y
CONFIG_DEFAULT_kmod-rssi-leds=y
...
CONFIG_PACKAGE_ubnt-base-files=y
CONFIG_UBNT_FIRMWARE_VERSION="XM.ar7240.v5.3.3.sdk"
CONFIG_PACKAGE_ubnt-web=y
...
# CONFIG_PACKAGE_libpthread-stubs is not set
...
# CONFIG_PACKAGE_libxyssl is not set
...
#
CONFIG_PACKAGE_olsrd-ninux=y
CONFIG_PACKAGE_olsrd-ninux-mod-arprefresh=y
# CONFIG_PACKAGE_olsrd-ninux-mod-bmf is not set
CONFIG_PACKAGE_olsrd-ninux-mod-dot-draw=y
CONFIG_PACKAGE_olsrd-ninux-mod-dyn-gw=y
# CONFIG_PACKAGE_olsrd-ninux-mod-dyn-gw-plain is not set
CONFIG_PACKAGE_olsrd-ninux-mod-httpinfo=y
CONFIG_PACKAGE_olsrd-ninux-mod-jsoninfo=y
CONFIG_PACKAGE_olsrd-ninux-mod-mdns=y
CONFIG_PACKAGE_olsrd-ninux-mod-nameservice=y
CONFIG_PACKAGE_olsrd-ninux-mod-p2pd=y
# CONFIG_PACKAGE_olsrd-ninux-mod-pgraph is not set
# CONFIG_PACKAGE_olsrd-ninux-mod-pud is not set
# CONFIG_PACKAGE_olsrd-ninux-mod-quagga is not set
# CONFIG_PACKAGE_olsrd-ninux-mod-secure is not set
CONFIG_PACKAGE_olsrd-ninux-mod-sgwdynspeed=y
# CONFIG_PACKAGE_olsrd-ninux-mod-tas is not set
CONFIG_PACKAGE_olsrd-ninux-mod-txtinfo=y
CONFIG_PACKAGE_olsrd-ninux-mod-watchdog=y
...
# CONFIG_PACKAGE_shorewall-common is not set
# CONFIG_PACKAGE_shorewall-lite is not set
# CONFIG_PACKAGE_shorewall-shell is not set
...
# CONFIG_PACKAGE_batmand-adv is not set
# CONFIG_PACKAGE_battool is not set
...
CONFIG_PACKAGE_tinysnmp-agent=y
CONFIG_PACKAGE_tinysnmp-module-ieee802dot11=y
CONFIG_PACKAGE_tinysnmp-module-interfaces=y
CONFIG_PACKAGE_tinysnmp-module-mikrotik=y
CONFIG_PACKAGE_tinysnmp-module-resources=y
# CONFIG_PACKAGE_tinysnmp-tools is not set
...
# CONFIG_PACKAGE_vnstati is not set
...
# CONFIG_PACKAGE_kmod-batman-advanced is not set
...
# Other modules
#
CONFIG_PACKAGE_kmod-ar7240-gpio=y
...
# CONFIG_PACKAGE_kmod-video-gspca is not set
# CONFIG_PACKAGE_kmod-video-konica is not set
# CONFIG_PACKAGE_kmod-video-nw8xx is not set
# CONFIG_PACKAGE_kmod-video-ov511 is not set
# CONFIG_PACKAGE_kmod-video-ov51x-jpeg is not set
# CONFIG_PACKAGE_kmod-video-ovcamchip is not set
# CONFIG_PACKAGE_kmod-video-pwc is not set
# CONFIG_PACKAGE_kmod-video-quickcam is not set
...
# CONFIG_PACKAGE_ov51x-jpeg-utils is not set
...
# CONFIG_PACKAGE_uvc-streamer is not set
...
# CONFIG_PACKAGE_libXxf86misc is not set
...
# CONFIG_PACKAGE_xcbproto is not set
...
# CONFIG_PACKAGE_evieext is not set
...
# CONFIG_PACKAGE_trapproto is not set
...
# CONFIG_PACKAGE_xf86miscproto is not set
# CONFIG_PACKAGE_xf86rushproto is not set
